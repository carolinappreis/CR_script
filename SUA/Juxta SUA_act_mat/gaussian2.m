...
for ii=1:size(all_regions,1)
    for  j=1:size(all_regions{ii,:},2)
        ...
        clearvars -except rec_pa rec_npa A all_regions ii j region_pl region_npl region_spl region_snpl output_pa output_npa ISI_all spikerate_all
...
color_b=[0.2 0.5 0.5];
color_s=[0.5 0.5 0.8];
titles={'short bursts','long bursts'};
for b=2
