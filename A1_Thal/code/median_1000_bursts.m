...
% plot(time(onset1{2}),env(onset1{2}),'b.')
...
% for i=1:size(thal_env,1)
% subplot(size(thal_env,1)+1,1,1)
% plot(time,env,time,threshold*ones(length(env),2))
% hold on
% plot(time(onset1{1}),env(onset1{1}),'r.')
% plot(time(onset1{2}),env(onset1{2}),'k.')
% xlim ([0 5])
% subplot(size(thal_env,1)+1,1,1+i)
% plot(time,thal_env(i,:))
% hold on
% plot(time(onset{1,1}),thal_env(i,onset{1,1}),'r.')
% plot(time(onset{2,1}),thal_env(i,onset{2,1}),'k.')
% xlim ([0 5])
% end
