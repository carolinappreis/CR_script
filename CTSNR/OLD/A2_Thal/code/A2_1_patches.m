...
subplot(2,1,1)
x=[-200:200];
y1=filt_best_stats(1,select);
y2=filt_best_stats(2,select);
y3=filt_best_stats(3,select);
load ('A2_1_SNR.mat')
y4=filt_best_stats(1,select);
y5=filt_best_stats(2,select);
y6=filt_best_stats(3,select);
color_bz=[0.5 0 0.5];
color_snr=[0 0 0.5];
plot(x, y2)
...
clear all
cd C:\Users\wolf5173\Documents\Carolina_code\codes_thal\A2_Thal\mat
load ('A2_1_BZ_surr.mat')
x=[-200:200];
y1=filt_best_stats(1,select);
y2=filt_best_stats(2,select);
y3=filt_best_stats(3,select);
load ('A2_1_SNR_surr.mat')
y4=filt_best_stats(1,select);
y5=filt_best_stats(2,select);
y6=filt_best_stats(3,select);
color_bz=[0.5 0 0.5];
