...
load('C:\Users\creis\OneDrive - Nexus365\Phasic_DBS\patient data\DBS_DATA\RS_hmm_posture.mat','RS_t','Fs','t')
d=RS_t; clear RS_t
load('C:\Users\creis\OneDrive - Nexus365\Phasic_DBS\patient data\DBS_DATA\RS_hmm_spiral.mat','RS_t')
...
for st = 1:options.K
    for ii=1:size(data,2)
        ...
        plot(fit.state(st).f,fit.state(st).psd(:,ii,ii),'LineWidth',1.5)
        hold on
