...
load('BZ_opt.mat'); color_b=[0.5 0 0];
...
for bi=1:size(ind_b1,2)
    clearvars -except ik bi ind_b1 ind_d1 new_idx  slip_b BZ color_b
...
%          for ct=1:size(BZ.phase_thal{BZ.idrat(ik),1},1)
           for ct=1;
            clearvars -except ik ct BZ epochs_zd1  slip_b ref3 bi ind_b1 ind_d1 new_idx epochs_zd color_b
