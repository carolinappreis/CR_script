...
for t=1:size(tp_s,1)
    for j = 1:length(tp_s{t,1})
        ...
        clearvars -except t j pc_before dum tp_s tp_e start dif_before ending
    end
end
...
for j=1:size(cr,2)
    ...
    clearvars -except t j pc_before dum tp_s tp_e pc_last cr dif_last dif_before start ending
end
...
for j=1:size(cr,2)
    if (~isnan(cr(j)))
        ...
        clearvars -except pc_first dif_first cr t j pc_after pc_before dum tp_s tp_e pc_last dif_before dif_last dif_after start ending
end
