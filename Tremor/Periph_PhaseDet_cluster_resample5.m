...
method = 'weighted'; %% Cluster method - change it here
...
%% Baseline
clearvars -except iii cohort fig fig2 pc_trials C_all C_RS C_NS PC A1 B1 nostimout_c1 nostim_c1 nostimout_c2 nostim_c2 randstim_change method
