...
function [mua] = makemua_emg(hpsig,msback,msfoward,muasr,rssr,uthresh)
...
clear muatemphp
clear muat
[betab,betaa] = butter(3,300/(muasr/2),'low');
muat = filtfilt(betab,betaa,E1z);

clear mua
    
mua = resample(muat(1:length(hpsig)),rssr,muasr);  
