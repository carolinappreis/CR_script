function [fig]=pha_slip_ctx_subref(coh_filts,name)
...
for pr=1:size(coh_filts,1)
    ...
    for ct=1:size(thal,1)
        ...
        clear pha_ctx epochs_z epochs_z1 znon_norm non_norm1 non_norm env onset offset1 dur dur_idx on epochs_zi
    end
    clear thal ctx
end
