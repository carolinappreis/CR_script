...
subplot(1,3,2)
bar(1:3,[nanmedian(fASNS(1,:)) nanmedian(fASNS(2,:)) nanmedian(fASNS(3,:))],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.3,'EdgeColor','none')
hold on
subplot(1,3,3)
...
% % %
% % % subplot(1,3,2)
% % % bar(1:2,[nanmedian(fASNS(1,:))  nanmedian(fASNS(2,:))],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.3,'EdgeColor','none')
% % % hold on
% % % subplot(1,3,3)
% % % bar(1:2,[ nanmedian(pASNS(1,:)) nanmedian(pASNS(2,:))],'FaceColor',[0.5 0.5 0.5],'FaceAlpha',0.3,'EdgeColor','none')
% % % hold on
% % % for i=1:size(fASNS,2)
% % %     cl= rand(1,3);
% % %     subplot(1,3,2)
