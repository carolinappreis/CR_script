...
for iii = 1:length(cohort)
    ...
    clearvars -except cohort plotp pcurve  iii F
    ...
    stt=floor((start1./samplerateold)*samplerate)+addon;
    ett=floor((ending1./samplerateold)*samplerate)+addon+addon_end;%floor(5*samplerate);
