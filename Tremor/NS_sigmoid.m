...
%     load(strcat('/Users/Carolina/OneDrive - Nexus365/Periph_tremor_data/Baseline/P0',num2str(iii(numb)),'_baseline.mat'))
    ...
    tremor3(1:size(ts1.data,1),1:size(ts1.data,3))=ts1.data;
    samplerate=1000;
    tt=0:1/samplerate:(size(tremor3,2)-1)/samplerate;
    tre_3=tremor3([3 5 6],:);
    ...
    for i=1:length(segmentb)
        gg=[gg ;(zenv(ax,(segmentb(i)-5000):(segmentb(i)+60000)))];  
    end
