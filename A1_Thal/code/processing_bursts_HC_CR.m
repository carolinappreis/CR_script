...
for i=2:(length(begin2)-1)
    if  (ending2(i)-begin2(i))<=200 && (ending2(i)-begin2(i))>=50 (begin2(i+1)-ending2(i))>=150 && (begin2(i)-ending2(i-1))>=150   % ending2(i)-begin2(i))>=200 ending2(i)-begin2(i)>150 && ending2(i)-begin2(i)<=250 % ending2(i)-begin2(i)>=250
        onset(1,m)=begin2(i)
...
if isempty (output1)
    ...
    for j=1:length(onset)
        if onset(j)-500>0 && onset(j)+500<length(env)
