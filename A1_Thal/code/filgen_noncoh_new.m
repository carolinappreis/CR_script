...
WaveData_DC(1+ii,:)=makemua_hayriye3(WaveData(1+ii,:)',0.001,0.003,round(samprateold),1000,4);
    end
...
clearvars -except med_thal_cell med_ctx n_bursts surr onset
run 'sort_data' % to save into format to be ploted in 'subplot_short.m' and 'subplot_long.m'
