...
for iii = 1:length(cohort)
    ...
    % % %
    %% Baseline
    clearvars -except iii cohort main method nostim tt1_all ns_mat b_amp bs_begin bs_end tremor_k  nostim_f
    ...
    for j = 1:5e4
        ...
        for ax = 1:3
            ...
            %             baseline3(ax,j)=(mean(envelope(ns_mat(iii,ax),end3-1000:end3))-mean(envelope(ns_mat(iii,ax), begin3-1000:begin3)))./mean(envelope(ns_mat(iii,ax), begin3-1000:begin3));
            %             b_amp(iii,ax,j)=mean(envelope(ns_mat(iii,ax), begin3-1000:begin3));
        end
    end
    ...
    for ax = 1:3
        ...
        baseline3_temp = squeeze(tremor_k(iii,ax,:));
    ...
    clearvars -except  cohort iii nostim tt1_all main method ns_mat b_amp bs_begin bs_end tremor_k  nostim_f
end
