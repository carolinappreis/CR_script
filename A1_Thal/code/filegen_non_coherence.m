...
for nn=1:length(state_mat);
    ...
    clearvars -except x med_thal_cell med_ctx nfile_i state_mat nn A check
...
n=1;
thal_long =[prctile(med_thal,25);median(med_thal);prctile(med_thal,75)];
ctx_long=[prctile(med_ctx,25);median(med_ctx);prctile(med_ctx,75)];
clearvars -except thal_long ctx_long
